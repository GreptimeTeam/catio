...
#[link(name = "aio")]
extern "C" {
    pub(super) fn io_setup(maxevents: c_int, ctxp: *mut IoContext) -> c_int;
    pub(super) fn io_destroy(ctx: IoContext) -> c_int;
    pub(super) fn io_submit(ctx: IoContext, nr: c_long, ios: *mut *mut Iocb) -> c_int;
    pub(super) fn io_cancel(ctx: IoContext, iocb: *mut Iocb, evt: *mut IoEvent) -> c_int;
    pub(super) fn io_getevents(
        ctx_id: IoContext,
        min_nr: c_long,
        nr: c_long,
        events: *mut IoEvent,
    ...
    pub(super) fn io_set_eventfd(iocb: *mut Iocb, eventfd: RawFd);
}
...
mod test {
    ...
    fn try_write() {
        ...
        let mut io_context = IoContext::default();
        ...
        let mut write_req = Iocb {
            aio_lio_opcode: IocbCmd::IO_CMD_PWRITE as u16,
            aio_fildes: fd as u32,
            aio_buf: write_buf as u64,
            aio_nbytes: 1024,
            aio_offset: 0,
